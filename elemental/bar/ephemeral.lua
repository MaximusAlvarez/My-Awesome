...
--Battery bar
local batter_bar = require("noodle.battery_wibar")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    --Create the batterybox
    s.mybatterybox = awful.wibar({screen = s, visible = true, ontop = true, type = "dock", position = "bottom", height = 5})
    -- Create the wibox
    ...
    awful.placement.maximize_horizontally(s.mybatterybox)

    --Battery bar setup 
    s.mybatterybox:setup {
        batter_bar,
